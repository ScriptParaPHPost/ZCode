...
(function($) {
	...
	$.wysibb.prototype = {
		...
		buildSelect: function(container, bn, opt) {
			var $btn = $('<div class="wysibb-toolbar-btn wbb-select wbb-' + bn + '">').appendTo(container).append(this.strf('<span class="val">{title}</span><ins class="caret-down"></ins>', opt)).append(this.strf('<span class="btn-tooltip">{title}</span>', {
				title: opt.title
			}));
