{foreach from=$tsTopUsers key=i item=u}
	<div class="filterShow-item d-flex entry-animation">
		...
		<div class="filterShow-item--title text-truncate flex-grow-1"><a href="{$tsConfig.url}/perfil/{$u.user_name}" rel="internal" class="text-truncate text-decoration-none w-100 d-block">{include "LinkAuthor.tpl" user=$u.user_name itemprop="url" itemtype="Person" normal=true}</a></div>
