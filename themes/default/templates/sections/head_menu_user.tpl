<div class="up-menu--item position-relative username">
	...
	<div class="up-dropdown up-dropdown--secondary position-absolute overflow-hidden p-2 body-bg rounded" style="right: 0;" data-dropname="userpanel" data-dropdown="false">
		...
		<a class="up-dropdown--item text-decoration-none fw-semibold rounded p-2 mt-2 hover:main-bg active:main-bg hover:main-color d-flex justify-content-start align-items-center gap-2 mx-0" title="Mis Borradores" href="{$tsConfig.url}/borradores/">{uicon class="box iconify-28" name="trash"} Mis Borradores</a>
