...
use app\interfaces\RegistroInterface;
...
class Registro implements RegistroInterface {
   ...
   */
      ...
      $return_avatar = $folder . DIRECTORY_SEPARATOR . "$uniq.webp";
	   ...
	   $origen = TS_AVATARES . $tsData['user_sexo'] . DIRECTORY_SEPARATOR;
		...
		foreach ($archivos as $archivo) {
		   // Incrementar el contador de im�genes
	...
	private function verify_recaptcha($captcha) {
   ...
   */
	public function registerUser() {
		...
		$this->verify_recaptcha($tsData['user_captcha']);
		// COMPROBAR VACIOS
