...
use app\interfaces\AfiliadoInterface;

use app\traits\System;

class Afiliado implements AfiliadoInterface {
	...
	public function newAfiliado(){
		...
		if(!$dataIn['titulo'] || !$dataIn['url'] || $dataIn['url'] == 'http://' || $dataIn['banner'] == 'http://' || !$dataIn['descripcion']) die('2: Faltan datos');
		// FILTRAMOS URL
