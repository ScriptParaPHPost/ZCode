...
<body style=\"width:500px;margin:1rem auto;\">
	<main style=\"margin:1rem auto;border-radius:.325rem;border:2px solid #555;padding:4rem 2rem 3rem 2rem;\">
		...
		<p>{contenido}</p>
		<p style=\"display: block;margin: 0;padding: 2rem 0 0 0;font-size:.75rem;color:#666;text-align:center;\">Si usted no pidi&oacute; recuperaci&oacute;n de su contrase&ntilde;a, ignore este e-mail.</p>
