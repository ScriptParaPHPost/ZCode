	...
	*/
	...
	public function getLastFotos(){
		...
		foreach($data['data'] as $fid => $foto) {
			...
			$data['data'][$fid]['foto_url'] = $tsCore->createLink('foto', [
				'user_name' => $foto['user_name'],
				'foto_id' => $foto['foto_id'],
				'f_title' => $foto['f_title']
			]);
		}
	...
	public function getLastComments() {
		...
		foreach($data as $fid => $foto) {
			...
			$data[$fid]['foto_url'] = $tsCore->createLink('foto', [
				'user_name' => $foto['user_name'],
				'foto_id' => $foto['foto_id'],
				'f_title' => $foto['f_title']
			], '#comment-' . $foto['cid']);
	...
	public function getFoto(){
		...
		foreach($data['amigos'] as $afid => $foto) {
			$data['amigos'][$afid]['foto_url'] = $tsCore->createLink('foto', [
				'user_name' => $foto['user_name'],
				'foto_id' => $foto['foto_id'],
				'f_title' => $foto['f_title']
			]);
		...
		foreach($data['ultimas_fotos'] as $ufid => $foto) {
			$data['ultimas_fotos'][$ufid]['foto_url'] = $tsCore->createLink('foto', [
				'user_name' => $foto['user_name'],
				'foto_id' => $foto['foto_id'],
				'f_title' => $foto['f_title']
			]);
