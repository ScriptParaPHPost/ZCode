...
class SmartyZCode {
   ...
   */
	...
	*/
	private function createObject(array $claves = []): string {
	   ...
	   $jsObjectString .= "\tcolores: ". json_encode($tsColores, JSON_FORCE_OBJECT) .",\n";
	   $jsObjectString .= "\tthemes: ". json_encode($tsSchemes) ."\n";
	   $jsObjectString .= "};";
	...
	*/
  	public function setStylesheets($styles): string {
	  	...
	  	foreach($newStyles as $style) $tagsCreated .= $this->setBuildTag($style);
