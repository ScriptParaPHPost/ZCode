...
class tsActualizacion {
	...
	protected $EXCLUDE = [
		...
		'storage/images/favicon',
		'storage/images/portadas',
		'storage/cache',
		'storage/.lock',
		'storage/dbconnect.php'
	];
	...
	public function api_response(string $type = '', string $commit = '') {
		...
		$curl[''] = "$ApiRepos/$user_repo";
		$curl['api'] = "$ApiRepos/$user_repo/commits";
		$curl['info'] = "$ApiRepos/$user_repo/branches/{$this->BRANCH}";
